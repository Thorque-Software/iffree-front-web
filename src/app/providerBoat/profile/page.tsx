...
import { getOneProvider,uploadProviderProfileImage,signOneMedia,getProviderProfit } from '@/services/ApiHandler';
...
export default function ProfilePage() {
  ...
  const fetchProfile = async (providerId: string) => {
    ...
    try {
      ...
      const res2 = await getProviderProfit(providerId,2024,10); // Ejemplo de uso de la nueva función
      setUser(res);
      if(res.media) {
